...
public class PullPinnedListView extends PullToRefreshAdapterViewBase<PinnedSectionListView>
{
    ...
    protected void onRefreshing(final boolean doScroll)
    {
        ...
        if (doScroll)
        {
            ...
            // Make sure the ListView is scrolled to show the loadWait
            // header/footer
    ...
    final class InternalListViewSDK9 extends InternalListView
    {
                                       ...
                                       int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent)
        {
            ...
            OverscrollHelper.overScrollBy(PullPinnedListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
